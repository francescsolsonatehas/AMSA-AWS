...
En aquest laboratori dissenyarem i implementarem una arquitectura de xarxa robusta i segura per allotjar una aplicació de WordPress. L'arquitectura es basa en la separació de capes (**pública, aplicació, dades**) i l'ús de **Availability Zones (AZ)** per garantir que el nostre WordPress sigui altament disponible i resistent a fallades.
...
- **Instàncies EC2 (WordPress)**: Distribuïdes en subxarxes privades de diferents AZ, accessibles només a través del Balancejador de Càrrega, mai directament des d'Internet.
...
:::{.callout-warning title="Attached IGW 🛑"}
...
![Taula de rutes per a la subxarxa AMSA-DMZ01-RT](../../figs/laboratories/03-aws-wp/AMSA-DMZ01-RT.png)
...
![Associació de la taula de rutes amb la subxarxa AMSA-DMZ-01](../../figs/laboratories/03-aws-wp/AMSA-DMZ-Subnet-Association.png)
...
![Permetem el tràfic amb l'exterior a través del IG](../../figs/laboratories/03-aws-wp/wordpress/IG.png)


:::{.callout-warning title="AMSA-DMZ-02 🛑"}
...
:::{.callout-note title="NAT Gateway 🧠"}
...
![Creació de la taula de rutes per a la subxarxa AMSA-Private01](../../figs/laboratories/03-aws-wp/AMSA-Private01-RT-create.png)
...
:::{.callout-warning title="AMSA-Private02 🛑"}
...
5. Configureu el grup de seguretat: **AMSA-VPN-SG**.
    ...
    Si reviseu la documentació d'instal·lació del servidor OpenVPN: [OpenVPN Access Server System Administrator Guide ](https://openvpn.net/images/pdf/OpenVPN_Access_Server_Sysadmin_Guide_Rev.pdf). Veure que necessitem els següents ports oberts: **TCP 943, UDP 1194**.
...
- [infra_v1.yaml](src/infra-v1.yaml): Aquest fitxer conté la infraestructura com a codi per crear tots els recursos d'AWS utilitzant AWS CloudFormation fins a la creació de templates de llançament.
- [infra_v2.yaml](src/infra-v2.yaml): Aquest fitxer conté la infraestructura com a codi per crear tots els recursos d'AWS utilitzant AWS CloudFormation sense el load balancer ni les instancies EC2 corresponents als WordPress.
