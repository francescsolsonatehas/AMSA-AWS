...
# Web Server Configuration with WordPress
...
:::{.callout-note title="WordPress installation and configuration script 📝"}
...
- Subxarxa: Select the subnet **AMSA-Private01** for the first instance and **AMSA-Private02** for the second instance. You can name them **AMSA-WP-01** i **AMSA-WP-02** respectively.


:::{.callout-important title="Note about EC2 instances 🖥️"}
