...
- EC2 instances distributed across private subnets in different AZs, accessible only through the Load Balancer, never directly from the Internet.”.
- **Load balancer** to distribute traffic to EC2 (WordPress) instances.
