...
- **Grups de Seguretat**: New security group (**AMSA-ALB-SG**), this security group will allow inbound traffic for ports 80 (HTTP) and 443 (HTTPS) from any source but will restrict outbound traffic to the EC2 instances (security group **AMSA-WP-SG**).
