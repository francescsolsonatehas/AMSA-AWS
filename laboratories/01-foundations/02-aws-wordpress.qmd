...
6. Add a rule to the **Security Group** of the database to allow connections from the EC2 instance.
 ...
 7. Connect to the RDS database from the EC2 instance:
    ...
    ```
   hostname is the database saved earlier: wordpress.cp66aquygfg3.us-east-1.rds.amazonaws.com
   
   i admin es l'usuari master creat abans, juntament amb la seva contrasenya
