---
title: 2 · Deploying a web application
lang: en
---
...
5. Afegir una regla al **Security Group** de la base de dades per permetre connexions des de la instància EC2.

	5.1. Anem a la consola d'**Amazon RDS**.
	5.2. Seleccionem la nostra instància de base de dades.
	5.3. A la secció de **Connectivity & security**, busquem el **Security Group** associat a la base de dades.
	5.4. Fem clic al **Security Group** per editar les regles (semblant a *default sg-0efc4051ab6288a2d*). 
	5.5. Afegim una nova regla d'entrada (Inbound rule) per permetre connexions des de l'adreça IP de la nostra instància EC2. Seleccionem el tipus de connexió **MySQL/Aurora** i introduïm l'adreça IP de la instància 			EC2. Per fer-ho, has de clicar a **Edit inbound rules** i després afegir la regla següent:
...
6. Per testejar la connexió, necessitem un client MySQL. La manera més senzilla és crear una instància EC2 i instal·lar el client MySQL.
