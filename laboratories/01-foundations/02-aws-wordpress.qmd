...
3. We need to add an inbound rule to the security group to allow HTTP connections:
    ...
    - In the section of **Security**, click on the **Security Group** associated with the instance (i.e. `sg-038f49ebd3fbe8b5a (launch-wizard-1)`).
    - Add a new inbound rule to allow HTTP connections. 
    	- Click `Edit Inbound rules`.  Insert the following:
...
Verify it: Insert `http://44.200.65.68` in a browser. It will appear in the screen **It works!**
