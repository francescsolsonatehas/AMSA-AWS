...
9.  SIf the file exists, you can run it with the following command:
...
- Download the data file  [`workload.csv`](./sources/workload.csv)  to your local computer.
...
- Reconnect to the EC2 instance via SSH, and run the Python program again:
