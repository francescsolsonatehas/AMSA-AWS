...
```bash
cd  # we suppose the .ssh directory will be located in the home of the user francesc
mkdir .ssh
```
...
You will now see the EC2 console. On the left side of the screen, you’ll find a list of options. Click on `Import key pair`, as shown below:
