...
::: {.center-container}
![](../figs/slides/01-foundations-of-systems-administration/enquesta_inicial.png){width="600px"}
:::
...
::::: columns
::: {.column width="20%"}
![](../figs/slides/01-foundations-of-systems-administration/chatgpt.png)
:::
...
::::: columns
::: {.column width="20%"}
![](../figs/slides/01-foundations-of-systems-administration/rae.jpeg)
:::
...
![](../figs/slides/01-foundations-of-systems-administration/visio.png)
...
::: {.callout-warning .fragment title="No es permet cap altre forma "}
...
## Avaluació · *Bonus 2* {.smaller}


::: columns
::: {.column width="50%"}
- Els materials de l'assignatura segueixen la metodologia de *Open Source*. 
- Això vol dir que qualsevol estudiant pot detectar errors, millorar els materials o afegir continguts nous. 
- Per tant, cada estudiant pot fer *fork* del repositori de l'assignatura i fer *pull request* amb les seves correccions i millores.
...
graph TD
        A(↓ Pull · git pull)
        B(Crea una branca · git branch)
        C(Fes canvis)
        D(↑ Push · git push)
        E(Obre una Pull Request)

    A -- "Actualitzar" --> B
    B -- "Treballar aïlladament" --> C
    C -- "Guarda els teus canvis" --> D
    D -- "Proposa els canvis" --> E

    style A fill:#e6f3ff,stroke:#007bff,stroke-width:2px;
    style B fill:#fff0e6,stroke:#ff8c00,stroke-width:2px;
    style C fill:#f0fff0,stroke:#28a745,stroke-width:2px;
    style D fill:#e6f9ff,stroke:#17a2b8,stroke-width:2px;
    style E fill:#e6e6ff,stroke:#6610f2,stroke-width:2px;
    ...
    linkStyle 3 stroke:#17a2b8,stroke-width:2px;
```
:::
:::
...
::: {.callout-warning .fragment title="Normativa de Convivència de la UdL"}
...
:::{.fragmet .center-container}
![](../figs/slides/01-foundations-of-systems-administration/bomber.png)
:::
...
:::{.fragmet .center-container}
![](../figs/slides/01-foundations-of-systems-administration/cientific.png)
:::
...
:::{.center-container}
![](../figs/slides/01-foundations-of-systems-administration/salaris/sysadmin-evol.png){width="80%"}

![](../figs/slides/01-foundations-of-systems-administration/salaris/sysadmin.png){width="80%"}
:::
...
::: {.column width="45%"}
[![](../figs/slides/01-foundations-of-systems-administration/jobs.png)](https://2459d6dc103cb5933875-c0245c5c937c5dedcca3f1764ecc9b2f.ssl.cf2.rackcdn.com/books/22_jobs3rd_complete.pdf)
:::
:::::
...
:::{.center-container}
![](../figs/slides/01-foundations-of-systems-administration/salaris/sre-evol.png){width="80%"}

![](../figs/slides/01-foundations-of-systems-administration/salaris/sre.png){width="80%"}
:::
...
:::{.center-container}
![](../figs/slides/01-foundations-of-systems-administration/salaris/devops-evol.png){width="80%"}

![](../figs/slides/01-foundations-of-systems-administration/salaris/devops.png){width="80%"}
:::
...
::: {.column width="60%"}
![](../figs/slides/01-foundations-of-systems-administration/terminologia/internet.png)
:::
:::::
...
::: {.center-container}
![](../figs/slides/01-foundations-of-systems-administration/terminologia/example-arquitectura.png)
:::
...
:::{.center-container}
![Esquema d'un centre dades](../figs/slides/01-foundations-of-systems-administration/data_center.png)
:::
...
:::{.center-container}
![Racks del CPD de la UdL](../figs/slides/01-foundations-of-systems-administration/terminologia/racks.png){width="50%"}
:::
...
:::: {.column width="40%"}
:::{.center-container}
![Rack 1 - GCD - Davant](../figs/slides/01-foundations-of-systems-administration/terminologia/rack1.png)
:::
::::
...
:::: {.column width="40%"}
:::{.center-container}
![Rack 1 - GCD - Darrera](../figs/slides/01-foundations-of-systems-administration/terminologia/rack2.png)
:::
::::
::::::::
...
:::: {.column width="40%"}
:::{.center-container}
![Exterior d'un servidor](../figs/slides/01-foundations-of-systems-administration/terminologia/stormy.png)
:::
::::
...
:::: {.column width="40%"}
:::{.center-container}
![Interior d'un servidor](../figs/slides/01-foundations-of-systems-administration/terminologia/servidor.png)
:::
::::
::::::::
...
:::{.center-container}
![Switch](../figs/slides/01-foundations-of-systems-administration/terminologia/switch.png){width="60%"}
:::
...
::: {.column .fragment width="35%" .center-container}
![Escalabilitat](../figs/slides/01-foundations-of-systems-administration/elasticitat.png)
:::
:::
::: {.column width="5%"}
:::

::: {.callout-tip .fragment title="Exemple"}
...
::: {.center-container}
![Esquema de tipus de virtualització de màquines virtuals](../figs/slides/01-foundations-of-systems-administration/virtualitzacio.png)
:::
...
classDiagram
    direction LR
    class OnPremise {
        On-Premise (Cuinar a Casa)
        Gestió total
        ✅ Forn, Gas/Electricitat
        ✅ Taula, Plats, Begudes
        ✅ Massa, Salsa, Ingredients
    }
    class IaaS {
        IaaS(Compra-la i Enforna-la)
        El proveïdor et dona la infraestructura
    ...
    class PaaS {
        PaaS(Pizza a Domicili)
        Et porten la plataforma llesta per usar
        ❌ Forn, Gas/Electricitat
        ✅ Taula, Plats, Begudes
        ❌ Massa, Salsa, Ingredients
    }
    class SaaS {
        SaaS(Menjar en un Restaurant)
        Un servei complet, tu només consumeixes
        ❌ Forn, Gas/Electricitat
        ❌ Taula, Plats, Begudes
        ❌ Massa, Salsa, Ingredients
    }
    ...
    style OnPremise fill:#d4edda,stroke:#28a745,stroke-width:2px;
    style IaaS fill:#fff3cd,stroke:#ffc107,stroke-width:2px;
    style PaaS fill:#cfe2ff,stroke:#0d6efd,stroke-width:2px;
    style SaaS fill:#f8d7da,stroke:#dc3545,stroke-width:2px;
```
...
::: {.center-container}
![](../figs/slides/01-foundations-of-systems-administration/aws-services.jpg)
:::
::: notes
...
::: {.center-container}
![Esquema de tipus de virtualització de contenidors (Docker)](../figs/slides/01-foundations-of-systems-administration/containers.png)
:::
...
::: {.center-container}
![Kubernetes](../figs/slides/01-foundations-of-systems-administration/kubernetes.png){width="80%"}
:::
::: notes
