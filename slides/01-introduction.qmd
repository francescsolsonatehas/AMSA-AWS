...
## Què és l'Administració de Sistemes? *Preconcepcions* {.smaller}

::::: columns
::: {.column width="65%"}
![](./figs/01-introduction/enquesta_inicial.png)
:::
...
## Què és l'Administració de Sistemes? *Definició segons ChatGPT* {.smaller}
